                            ...
                            <td className="px-2 py-3">
                              {podeEditar && (
                                <div className="flex items-center gap-1">
                                  <button onClick={() => { setEditingMedicaoId(m.id); setEditMedicaoForm({ data_medicao: m.data_medicao, peso_kg: String(m.peso_kg), altura_cm: String(m.altura_cm) }) }} className="text-stone-400 hover:text-orange-500 p-2 text-lg leading-none">✎</button>
                                  {profile?.role === 'admin' && (
